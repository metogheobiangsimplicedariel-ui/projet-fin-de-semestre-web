...
<aside class="w-64 bg-slate-900 text-white hidden lg:flex flex-col z-20 shadow-xl flex-shrink-0">
    ...
    <nav class="flex-grow p-4 space-y-2 text-sm">
        ...
        <a href="index.php?page=admin_results"
            class="flex items-center gap-3 px-4 py-3 rounded-lg transition-colors <?= ($page === 'admin_results') ? 'bg-blue-600 text-white shadow-lg shadow-blue-500/30' : 'text-slate-400 hover:bg-slate-800 hover:text-white' ?>">
            <div class="w-5 h-5 flex items-center justify-center">
                <i class="fa-solid fa-square-poll-vertical"></i>
            </div>
            <span class="font-medium text-sm">Délibération</span>
        </a>
